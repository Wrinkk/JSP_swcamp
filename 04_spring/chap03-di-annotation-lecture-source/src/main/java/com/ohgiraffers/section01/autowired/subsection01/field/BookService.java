...
public class BookService {
    ...
    /* 설명.
     *  아래의 세가지는 ComponentScan 범위 안에 애노테이션들이 달렸을 때 유효하다.
     ...
     *  3. @Autowried에 의해서 BookDAO 타입의 빈이 BookService의 필드인 bookDAO 필드에 주입된다.(대입된다.)
     * */

    @Autowired
    /* ComponentScan 범위 안에 BookDAO 타입의 bean이 대입됨 */
    private BookDAO bookDAO; // = new BookDAOImpl(); 와 같은 의미

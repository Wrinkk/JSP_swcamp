...
public class FileUploadController {
    ...
    /* 설명. build된 파일 업로드 할 경로를 가져오기 위해 ResourceLoad 의존성 주입 받기 */
    @Autowired
...
//        System.out.println("빌드 된 single 디렉토리의 절대경로: " + resource.getFile().getAbsolutePath());
        ...
        try {
            ...
            /* 설명. try 구문 안에서(DB를 다녀오는 business logic 처리 */
    ...
    public String muitlFileUpload(@RequestParam List<MultipartFile> multiFiles,

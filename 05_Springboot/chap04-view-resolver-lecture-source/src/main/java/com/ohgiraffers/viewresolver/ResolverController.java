...
public class ResolverController {
    ...
    public String stringRedirect(Model model) {
        model.addAttribute("message1", "문자열로 뷰어를 반환하여 리다이렉트");
    ...
    /* 설명. 기존에 핸들러 메소드가 'void 또는 String'으로만 반환했는데 ModleAndView를 반환하는 것도 해보자.*/
    ...
    public ModelAndView modelAndViewRedirect(ModelAndView mv) {
        ...
        mv.addObject("message2", "ModelAndView을 이용한 redirect");
    ...
    public ModelAndView modelAndViewRedirectAttr(ModelAndView mv, RedirectAttributes rttr) {
        rttr.addFlashAttribute("flashMessage2", "ModelAndView을 이용한 redirect attr");
        mv.setViewName("redirect:/");

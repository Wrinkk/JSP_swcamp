...
public class RequestHeaderPrintServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
         ...
         * 설명.
         *  1. General Header
         *   : 요청 및 응답 모두 적용 되지만 최종적으로는 body에 전송되는 것과는 관련이 없는 헤더이다.
         *  2. Request Header
         *   : 패치 될 리소스나 클라이언트 자체에 대한 상세 정보를 포함하는 헤더이다. (쿠키포함)
         *  3. Response Header
         ...
         *     (Content_Length, Content_Type, Content-Language, Content-Encoding)
         * */
        Enumeration<String> headerNames = req.getHeaderNames(); // header가 넘어옴

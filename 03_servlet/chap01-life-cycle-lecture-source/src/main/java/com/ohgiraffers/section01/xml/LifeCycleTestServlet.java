...
/* 설명. servlet으로 쓰려면 extends HttpServlet을 해줘야 함 */
public class LifeCycleTestServlet extends HttpServlet {
    ...
    /* 설명. 컨테이너가 종료될 때 호추하는 메소드이며 주로 자원을 반납하는 용도로 사용된다. */
    @Override
    public void destroy() {
    ...
    * */
    ...
    public void service(ServletRequest request, ServletResponse response)
        ...
        System.out.println("실제로는 이 곳에서 요청 방식에 따라 deGet() 또는 doPost()가 실행됨!!");
    }

    /* 설명.
     *  서블릿 라이프 사이클: init() -> service() 반복(deGet() 또는 doPost() 동작) -> destroy()
    * */
}

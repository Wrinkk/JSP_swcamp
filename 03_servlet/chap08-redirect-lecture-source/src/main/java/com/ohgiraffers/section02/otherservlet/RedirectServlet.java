...
public class RedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("리다이렉트 이후 request의 attribute: " + req.getAttribute("test")); // null 출력

        /* 설명. 파라미터가 넘어오면 rrequest 객체가 달라져도 값이 전달되어 온다. */
        ...
        * */
        ...
        /* 설명.
         *  포워딩 VS 리다이렉트
         *  - request나 response객체를 유지하여 요청 처리를 하고 싶다면 포워딩을 사용하자.
